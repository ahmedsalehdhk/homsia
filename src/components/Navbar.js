    ...
    return (
        <nav className="bg-transparent text-white flex justify-between items-center px-6 md:px-10 py-6 fixed w-screen duration-700 z-[100]" id="nav">
            ...
            <ul className="nav-links gap-5 hidden md:flex">
                <li className="capitalize font-medium"><Link>home</Link></li>
                <li className="capitalize font-medium"><Link>services</Link></li>
                <li className="capitalize font-medium"><Link>featured</Link></li>
                <li className="capitalize font-medium"><Link>contact</Link></li>
            </ul>
            ...
            <div className="mobile-nav px-10 flex justify-end items-center md:hidden absolute top-0 bg-white text-black text-xl h-screen w-4/5 duration-500 shadow-2xl" id="mobile-nav">
